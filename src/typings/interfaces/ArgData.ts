...
export type DefaultMethod<Type extends ArgType, Enum extends EnumLike, Choices extends string[]> = (this: NekoClient, interaction: ChatInputCommandInteraction) => UnwrapArgType<Type, Enum, Choices> | null 
